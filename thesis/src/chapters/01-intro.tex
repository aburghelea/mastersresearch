...
From a technical point of view the role of team leader is responsible of delivering a high quality product on time by leveraging the knowledge of each member. As detailed in \labelindexref{Chapter}{chapter:existing} there are two main directions for leading a project oriented team.
...
During the last three years, I had the opportunity to fill all the leadership positions described in \labelindexref{Chapter}{chapter:existing}. As a technical leader I was in charge of a team of 8 juniors, as a technical coach I lead two teams: 2 member team (both senior) and a 7 member team (mixed seniority levels) and as a people manager I had 5 direct reports with seniority levels equal or lower than mine. 
